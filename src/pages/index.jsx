...
const IndexPage = ({data}) => (<div className="body home-colors">
  <div id="app" className="wrapper">
    <Header/>
    <Intro/>
    <section className="projects grid">
      {
        data.allMarkdownRemark.edges.map(post => (<div className="project grid__col grid__col--1-of-3" key={post.node.id}>
          <span className="meta-data code">{post.node.frontmatter.tags}</span>
          <Link to={post.node.frontmatter.path} className="faux-link">
